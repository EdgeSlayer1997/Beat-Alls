const checkPermission = (userRole, requestedRoute) => {
    if (userRole === 'Administrador' && (requestedRoute === "/registrarProveedores" || requestedRoute === "/proveedoresRegistrados" requestedRoute === "/registroProductos" requestedRoute === "/productosRegistrados" requestedRoute === "/registroUsuarios" requestedRoute === "/usuariosRegistrados" requestedRoute === "/clientesRegistrados" requestedRoute === "/pedidosFinalizados" requestedRoute === "/pedidosEnCurso" requestedRoute === "/logsUsuarios" requestedRoute === "/logsClientes") {
        return true;
